...
//					String dir = MainActivity.this.getFilesDir().toString();
					String dir = "/sdcard/inject";
					String inject = dir + "/inject";
					String proc = "com.example.javahook";
					String lib = dir + "/libinjectso.so";
