...
#define LOGDTAG(TAG, ...) __android_log_print(ANDROID_LOG_DEBUG, TAG, __VA_ARGS__)
#define LOGITAG(TAG, ...) __android_log_print(ANDROID_LOG_INFO, TAG, __VA_ARGS__)
#define LOGWTAG(TAG, ...) __android_log_print(ANDROID_LOG_WARN, TAG, __VA_ARGS__)
